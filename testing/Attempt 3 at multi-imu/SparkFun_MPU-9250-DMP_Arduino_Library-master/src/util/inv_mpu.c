...
struct hw_s hw = { // naughty to not use const... but no other way to set addr dynamically
    //.addr           = 0x69,
    .max_fifo       = 1024,
    .num_reg        = 128,
    .temp_sens      = 321,
 ...
 */
int set_int_enable(unsigned char enable, unsigned char addr)
{
    unsigned char tmp;
 ...
 *  @param[in]  reg     Register add.
 *  @param[out] data    Register data.
 *  @return     0 if successful.
 */
int mpu_read_reg(unsigned char reg, unsigned char *data, unsigned char addr)
{
 ...
 *  @return     0 if successful.
 */
int mpu_init(struct int_param_s *int_param, unsigned char addr)
{
...
// unsigned char mpu_get_addr() 
// {
//     return hw.addr; // bogus
// }
 ...
 *  @return     0 if successful.
 */
int mpu_lp_accel_mode(unsigned short rate, unsigned char addr)
{
    unsigned char tmp[2];
 ...
 *  @return     0 if successful.
 */
int mpu_get_gyro_reg(short *data, unsigned long *timestamp, unsigned char addr)
{
    unsigned char tmp[6];
 ...
 *  @return     0 if successful.
 */
int mpu_get_accel_reg(short *data, unsigned long *timestamp, unsigned char addr)
{
    unsigned char tmp[6];
 ...
 *  @return     0 if successful.
 */
int mpu_get_temperature(long *data, unsigned long *timestamp, unsigned char addr)
{
    unsigned char tmp[2];
    short raw;
 ...
 *  @return     0 if successful.
 */
int mpu_read_6500_accel_bias(long *accel_bias, unsigned char addr) {
	unsigned char data[6];
 ...
 *  @return     0 if successful.
 */
int mpu_read_6050_accel_bias(long *accel_bias, unsigned char addr) {
	unsigned char data[6];
...
int mpu_read_6500_gyro_bias(long *gyro_bias, unsigned char addr) {
	unsigned char data[6];
 ...
 *  @return     0 if successful.
 */
int mpu_set_gyro_bias_reg(long *gyro_bias, unsigned char addr)
{
 ...
 *  @return     0 if successful.
 */
int mpu_set_accel_bias_6050_reg(const long *accel_bias, unsigned char addr) {
    unsigned char data[6] = {0, 0, 0, 0, 0, 0};
 ...
 *  @return     0 if successful.
 */
int mpu_set_accel_bias_6500_reg(const long *accel_bias, unsigned char addr) {
    unsigned char data[6] = {0, 0, 0, 0, 0, 0};
    long accel_reg_bias[3] = {0, 0, 0};
 ...
 *  @return     0 if successful.
 */
int mpu_set_gyro_fsr(unsigned short fsr, unsigned char addr)
{
    unsigned char data;
 ...
 *  @return     0 if successful.
 */
int mpu_set_accel_fsr(unsigned char fsr, unsigned char addr)
{
    unsigned char data;
 ...
 *  @return     0 if successful.
 */
int mpu_set_lpf(unsigned short lpf, unsigned char addr)
{
    unsigned char data;
 ...
 *  @return     0 if successful.
 */
int mpu_set_sample_rate(unsigned short rate, unsigned char addr)
{
    unsigned char data;
 ...
 *  @return     0 if successful.
 */
int mpu_set_compass_sample_rate(unsigned short rate, unsigned char addr)
{
#ifdef AK89xx_SECONDARY
    unsigned char div;
 ...
 *  @return     0 if successful.
 */
int mpu_configure_fifo(unsigned char sensors, unsigned char addr)
{
    unsigned char prev;
    int result = 0;
    ...
    if (false)//(st.chip_cfg.dmp_on) #changed
        return 0;
    else {
        if (!(st.chip_cfg.sensors))
            return -1;
 ...
 *  @return     0 if successful.
 */
int mpu_set_sensors(unsigned char sensors, unsigned char addr)
{
    unsigned char data;
#ifdef AK89xx_SECONDARY
    unsigned char user_ctrl;
 ...
 *  @return     0 if successful.
 */
int mpu_get_int_status(short *status, unsigned char addr)
{
    unsigned char tmp[2];
    if (!st.chip_cfg.sensors)
        return -1;
...
int mpu_read_fifo(short *gyro, short *accel, unsigned long *timestamp,
        unsigned char *sensors, unsigned char *more, unsigned char addr)
{
...
int mpu_read_fifo_stream(unsigned short length, unsigned char *data,
    unsigned char *more, unsigned char addr)
{
    unsigned char tmp[2];
 ...
 *  @return     0 if successful.
 */
int mpu_set_bypass(unsigned char bypass_on, unsigned char addr)
{
    unsigned char tmp;
 ...
 *  @return     0 if successful.
 */
int mpu_set_int_latched(unsigned char enable, unsigned char addr)
{
    unsigned char tmp;
...
#ifdef MPU6050
static int get_accel_prod_shift(float *st_shift, unsigned char addr)
{
...
static int gyro_self_test(long *bias_regular, long *bias_st, unsigned char addr)
{
    int jj, result = 0;
    unsigned char tmp[3];
...
static int get_st_biases(long *gyro, long *accel, unsigned char hw_test, unsigned char addr)
{
    unsigned char data[MAX_PACKET_LENGTH];
...
static int accel_6500_self_test(long *bias_regular, long *bias_st, int debug, unsigned char addr)
{
...
static int gyro_6500_self_test(long *bias_regular, long *bias_st, int debug, unsigned char addr)
{
    int i, result = 0, otp_value_zero = 0;
...
static int get_st_6500_biases(long *gyro, long *accel, unsigned char hw_test, int debug, unsigned char addr)
{
 ...
 */
int mpu_run_6500_self_test(long *gyro, long *accel, unsigned char debug, unsigned char addr)
{
 ...
 *  @return     Result mask (see above).
 */
int mpu_run_self_test(long *gyro, long *accel, unsigned char addr)
{
#ifdef MPU6050
    const unsigned char tries = 2;
    long gyro_st[3], accel_st[3];
 ...
 *  @param[in]  mem_addr    Memory location (bank << 8 | start add)
 ...
 *  @param[in]  start_addr  Starting add of DMP code memory.
 *  @param[in]  sample_rate Fixed sampling rate used when DMP is enabled.
 *  @return     0 if successful.
 */
int mpu_load_firmware(unsigned short length, const unsigned char *firmware,
    unsigned short start_addr, unsigned short sample_rate, unsigned char addr)
{
    unsigned short ii;
...
#define LOAD_CHUNK  (16)
    ...
    // if (st.chip_cfg.dmp_loaded)              #changed to allow reading two IMUs
 ...
 *  @return     0 if successful.
 */
int mpu_set_dmp_state(unsigned char enable, unsigned char addr)
{
    unsigned char tmp;
    // if (st.chip_cfg.dmp_on == enable) #change to get imu2 reading faster
    //     return 0;
...
static int setup_compass(unsigned char addr)
{
    ...
    /* Find compass. Possible addes range from 0x0C to 0x0F. */
 ...
 *  @return     0 if successful.
 */
int mpu_get_compass_reg(short *data, unsigned long *timestamp, unsigned char addr)
{
#ifdef AK89xx_SECONDARY
    unsigned char tmp[9];
...
int mpu_lp_motion_interrupt(unsigned short thresh, unsigned char time,
    unsigned short lpa_freq, unsigned char addr)
{
